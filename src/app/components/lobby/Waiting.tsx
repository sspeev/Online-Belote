  ...
  return (
    <section className="create-container h-screen relative overflow-hidden">
      ...
      <main className="container top-10 lg:top-10 lg:left-10 absolute mx-auto flex flex-col items-center">
        <header className="w-full flex flex-col lg:flex-row justify-end items-center bg-gradient-to-b from-secondary-light to-secondary-dark rounded-xl p-8 mb-10">
            ...
            <div className="button-wrapper">
              ...
              {playerData.player.host && (
                <Button
                  ...
                  additionalStyles={lobby.playerCount < 4 ? 'opacity-50 pointer-events-none' : ''}
                />
              )}
            </div>
          </div>
