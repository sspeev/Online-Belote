...
describe('GameStatus Component', () => {
  ...
  it('renders nothing when gamePhase is waiting', () => {
    const { container } = render(
      <GameStatus gamePhase="waiting" currentAnnounce={Announces.None} passCounter={0} />
    )
  ...
  it('renders current player turn and phase', () => {
    render(
      <GameStatus gamePhase="bidding" currentPlayerName="TestPlayer" currentAnnounce={Announces.None} passCounter={0} />
    )
  ...
  it('renders current announce correctly', () => {
    render(
      <GameStatus gamePhase="bidding" currentPlayerName="TestPlayer" currentAnnounce={Announces.Hearts} passCounter={0} />
    )
  ...
  it('renders pass counter when passCounter > 0 in bidding phase', () => {
    render(
      <GameStatus gamePhase="bidding" currentPlayerName="TestPlayer" currentAnnounce={Announces.Hearts} passCounter={2} />
    )
